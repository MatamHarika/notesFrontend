    ...
    return(
        ...
        <div className="container px-1 ">
            {allNotes.length>0 ?<div className="grid grid-cols-3 gap-4 mt-8 flex mb-4">
                ...
                />))}
            </div> : (<EmptyCard imgSrc="src\assets\notes-memo-icon-symbol-clipart-with-paperclip-isolated-on-white-background-vector.jpg" message={isSearch ? 'Oops no records found':'start creating your first note! click `add` button to drop down your ideas thoughts and remainders '}/>) }
        </div>
